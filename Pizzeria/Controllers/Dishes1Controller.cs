...
namespace Pizzeria.Controllers
{
    public class Dishes1Controller : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DishId,Name,Price,Image,DishCategoryId")] Dish dish)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DishId,Name,Price,Image,DishCategoryId")] Dish dish)
        {
            if (id != dish.DishId)
            {
                return NotFound();
